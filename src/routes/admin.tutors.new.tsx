...
import { AdminNewTutorPage } from "@/pages/admin/AdminNewTutorPage";
...
export const Route = createFileRoute("/admin/tutors/new")({
  head: () => ({ meta: [{ title: "New Admin Tutor | YiroInc Academia Portal" }] }),
