 ...
 * and GET /auth/me. Admin identity comes from auth/user flags and takes
 * precedence over any historical profile_type.
 */
export function useCurrentUser(): CurrentUser {
  const { user, profile, isAdmin, experience } = useAuth();
