...
import { ShoppingBag, CreditCard, Bell, BookOpen, ArrowRight, Upload } from "lucide-react";

import { AppShell, PageHeader } from "@/layouts/UserLayout/AppShell";
import { SectionCard, EmptyState } from "@/components/shared/DashboardCard";
import { Button } from "@/components/ui/button";
import { useCurrentUser } from "@/lib/auth/current-user";
import { useGeneralDashboard } from "@/features/dashboard/hooks";
...
export function AcademicDashboardPage() {
  ...
  const dashboard = useGeneralDashboard();
